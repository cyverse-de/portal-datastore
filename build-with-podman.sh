...
Examples:
    $0 -i harbor.cyverse.org/de/portal-datastore -t v1.0.0 -o build.json
    $0 -i harbor.cyverse.org/de/portal-datastore -t latest -o artifacts.json -p
    $0 -d custom.Dockerfile -i harbor.cyverse.org/de/portal-datastore -o build.json -c /path/to/context
EOF
}
